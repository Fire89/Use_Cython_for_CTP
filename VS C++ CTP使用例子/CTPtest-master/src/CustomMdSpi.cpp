...
void CustomMdSpi::OnRtnDepthMarketData(CThostFtdcDepthMarketDataField *pDepthMarketData)
{
	...
	std::cout << std::setw(10) << "合约代码";
	std::cout << std::setw(10) << "最新价";	
	std::cout << std::setw(10) << "卖价";
	std::cout << std::setw(10) << "卖量";
	std::cout << std::setw(10) << "成交量";
	std::cout << std::setw(16) << "更新时间" << std::endl;
	...
	std::cout << std::setw(10) << "涨跌";
	std::cout << std::setw(10) << "买价";
	std::cout << std::setw(10) << "买量";	
	std::cout << std::setw(10) << "持仓量";
	std::cout << std::setw(16) << "换手率" << std::endl;
	std::cout << std::setw(10) << pDepthMarketData->OpenInterest - pDepthMarketData->PreOpenInterest;   // 日增减仓
	...
	{
		std::cout << "-------------------价格已经到设定的预警价位---------------------------" << std::endl;
