...
TThostFtdcInvestorIDType gInvesterID = "073232";                         // 投资者账户名
TThostFtdcPasswordType gInvesterPassword = "13157025707";                     // 投资者密码

// 行情参数
CThostFtdcMdApi *g_pMdUserApi = nullptr;                           // 行情指针
char gMdFrontAddr[] = "tcp://180.168.146.187:10011";               // 模拟行情前置地址
char *g_pInstrumentID[] = { "bu1809", "MA809"}; // 行情合约代码列表，中、上、大、郑交易所各选一种
int instrumentNum = 2;                                             // 行情合约订阅数量
...
TThostFtdcInstrumentIDType g_pTradeInstrumentID = "bu1809";        // 所交易的合约代码
