    ...
    def task_main(self):
        ...
        while True:
            ...
            wait_result = yield {
                ...
                (
                     quote_a["bid_price1"] - self.b <= -m
                  or quote_a["bid_price1"] - self.b >= m
                  or (quote_a["bid_price1"] - self.bf['a1'] <= -n and self.bf['a1'] > self.b)
                ),
            }            
            ...
            if wait_result["PRINT"]:             
                if self.bf['a1'] !=quote_a["bid_price1"] and long_volume != 0:
                    if self.bf['a1'] + n == quote_a["bid_price1"] :
                        print('@  a1:',  quote_a["bid_price1"] ," self.b:", self.bf['a1'])
                        self.bf['a1'] = quote_a["bid_price1"]
                        print('@3 a1:',  quote_a["bid_price1"] ," self.b:", self.bf['a1'])              
...
"""
    ...
    运行后开仓 多单1手，成交后判断平仓条件:
        ...
        条件 2. 最新价 大于持仓价4个价位，将持仓价提高4（即 持仓价 + 6）作为新的持仓价，为了理解方便设：x
                之后分2种情况:
